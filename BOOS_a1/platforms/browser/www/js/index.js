...
var app = {
    ...
    receivedEvent: function(id) {
		...
		var myrestaurants = L.geoJson(rest, {pointToLayer:
        ...
        var marker = L.marker([47.377, 8.542], {icon: worldIcon},{rotationAngle: 315.96});
        
        // define variable for circle with radius 100 below marker
        var circle = L.circle([47.377, 8.542], {radius: 100});
        ...
        */
        var watchID = navigator.geolocation.watchPosition(onSuccess, onError, {maximumAge: 6000, timeout: 30000, enableHighAccuracy: true }); //watch position: continuously tells me where I am
